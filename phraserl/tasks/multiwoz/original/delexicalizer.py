"""
Original code:
https://github.com/budzianowski/multiwoz/blob/master/utils/delexicalize.py
"""
...
def prepareSlotValuesIndependent():
    ...
    for domain in domains:
        try:
            fin = open(os.path.join(DB_DIR, f"{domain}_db.json"))
    ...
    fin = open(os.path.join(DB_DIR, "train_db.json"))
    db_json = json.load(fin)
    fin.close()
